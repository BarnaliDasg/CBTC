        ...
        <div class="col-8">
            <div class="card mt-4">
                <div class="card-title d-flex justify-content-between  align-items-center">
                    ...
                    <div class="d-flex align-items-center p-2">
                        <img src="assets/images/profile/<?=$user['profile_pic']?>" alt="" height="30" class="rounded-circle border">&nbsp;&nbsp;Barnali Das
                    </div>
                    <div class="p-2">
                        <i class="bi bi-three-dots-vertical"></i>
                    </div>
                </div>
                <img src="assets/images/profile/<?=$user['profile_pic']?>" class="" alt="...">
            ...
            <div class="card mt-4">
                <div class="card-title d-flex justify-content-between  align-items-center">
                    ...
                    <div class="d-flex align-items-center p-2">
                        <img src="assets/images/profile/pp.jpg" alt="" height="30" class="rounded-circle border">&nbsp;&nbsp;Barnali Das
                    </div>
                    <div class="p-2">
                        <i class="bi bi-three-dots-vertical"></i>
                    </div>
        ...
        <div class="col-4 mt-4 p-3">
            ...
            <div>
                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center p-2">
                        <div><img src="assets/images/profile/<?=$user['profile_pic']?>" alt="" height="40" class="rounded-circle border">
                        </div>
                        <div>&nbsp;&nbsp;</div>
