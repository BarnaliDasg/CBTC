<div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
    <form method="post" action="assets/php/actions.php?login" style="width: 70%; max-width: 600px; box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.2); border-radius: 10px; padding: 20px;">
        <div class="text-center mb-3">
            <img src="assets/images/cds.png" alt="Logo" height="50" style="height: 45;">
